...
func (n *NetStar) List() ([]string, error) {
	...
	headers = fmt.Sprintf(headers, n.Cookie)

	body := ""
	//fmt.Printf("请求数据：%s\n", body)

	client := NewNetClient(url, "POST", headers, string(body), nil, nil, 0)
	err := client.Do()
...
func (n *NetStar) ListDetail(goodsNumbers []string) (*model.GoodListDto, error) {
...
func (n *NetStar) Detail(goodsNumber string) (*model.GoodDetailDto, error) {
...
func (n *NetStar) Buy(goodsNumber, buyToken string) (string, error) {
...
func (n *NetStar) Pay(orderId string) (float64, error) {
...
func (n *NetStar) Orders(pageNo, pageSize int32) (*model.OrderListDto, error) {
